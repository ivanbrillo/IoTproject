...
public class DatabaseManager {
    ...
    public void storePowerData(String jsonPayload) {
        ...
        try {
            ...
            double predValue = json.get("pred").getAsDouble();
    ...
    public void storeBatteryData(String jsonPayload) {
        ...
        try {
            ...
            logger.info("Battery SOC received (v{}): {} (not stored - no battery table)", 
                       version, socValue);
        } catch (Exception e) {
            logger.error("Error processing battery data: {}", jsonPayload, e);
        }
    }
